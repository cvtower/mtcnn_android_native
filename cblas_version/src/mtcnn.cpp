...
Pnet::Pnet(){
    ...
    string filename = "/data/local/tmp/Pnet.txt";
...
Rnet::Rnet(){
    ...
    string filename = "/data/local/tmp/Rnet.txt";
    readData(filename, dataNumber, pointTeam);
...
Onet::Onet(){
    ...
    string filename = "/data/local/tmp/Onet.txt";
    readData(filename, dataNumber, pointTeam);
...
void mtcnn::findFace(Mat &image){
	...
	RUNtime = (endtime - starttime) / (1000 * cvGetTickFrequency());
	//printf("the first stage RUN time:%f ms\n", RUNtime);
	...
	endtime = cvGetTickCount();
	RUNtime = (endtime - starttime) / (1000 * cvGetTickFrequency());
	//printf("the second stage RUN time:%f ms\n", RUNtime);
	...
	endtime = cvGetTickCount();
	RUNtime = (endtime - starttime) / (1000 * cvGetTickFrequency());
	//printf("the thrid stage RUN time:%f ms\n", RUNtime);
